...
function setupThreeJS() {
  ...
  scene.fog = new THREE.FogExp2(0xFFB6C1, 0.002);
...
function setupWorld() {
  ...
  var mat = new THREE.MeshPhongMaterial({color: 0xFFFFE0, overdraw: true});
...
// console.log (Math.floor())
  ...
  for (var i = 0; i < 300; i++) {
    ...
    building.position.y = Math.floor( Math.random() * 100 - 50 ) * 4;
  //  building.scale.x=10;
  //  building.scale.y=10;
  //  building.scale.z=10;
  ...
  //  cityGeometry.merge(building.geometry, buildings.matrix);
