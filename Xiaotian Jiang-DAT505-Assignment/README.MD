Final work
=======
B161006069 Xiaotian Jiang
[My Github link](http://github.com/Jshout1/Dat505-Github) &mdash;
#### My inspiration ####
The hand is one of the most familiar parts of the body to us. It is controlled by the brain and helps us complete activities. However, most people can't control the joints of their fingers exactly as they think they should because of nerve and muscle effects.
So i wanted to make a hand that was completely free to control all the joints to find out what these neurological and muscular effects are.
...
```
Draw the palm and fingers and place them in the right positions.
Add these mesh to the scene.
...
```
Since i want to style this hand as a wireframe, I defined some points and faces.So that the since more simple and beautiful.
...
```
Control the rotation angle of fingerjoints when changing the interface.
```javascript
function setupGui() {
