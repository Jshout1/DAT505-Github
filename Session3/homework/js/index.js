...
function init(){
  ...
  renderer.setClearColor(0xa5291b, 1);
  ...
  var geometry2 = new THREE.SphereBufferGeometry( 100, 32, 32 );
  var material2 = new THREE.MeshBasicMaterial( {color: 0xff4e40} );
  var sphere = new THREE.Mesh( geometry2, material2 );

  var texture = new THREE.TextureLoader().load ('texture/ge.jpg');
...
/*  var material = new THREE.MeshLambertMaterial({
  ...
  mesh1.position.set(0, 1, 50);
  mesh1.rotation.set(0, 0, 0);
  mesh1.rotation.x = de2ra(-28);
  mesh1.scale.set(200, 1, 200);
  mesh1.doubleSided = true;
  mesh1.castShadow = true;
  scene.add(mesh1);

  mesh2 = new THREE.Mesh(geometry2, material2);
  mesh2.position.set(0, -300, -400);
  mesh2.rotation.set(0, 0, 0);
  mesh2.rotation.y = de2ra(30);
